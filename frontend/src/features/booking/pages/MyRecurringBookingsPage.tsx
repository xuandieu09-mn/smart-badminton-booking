...
export const MyRecurringBookingsPage: React.FC = () => {
    ...
    const fetchRecurringBookings = async () => {
        try {
            ...
            const recurringBookings = bookings.filter(b => b.isRecurring && b.recurrenceGroupId);
            ...
            setError(error.response?.data?.message || 'Không thể tải danh sách đặt lịch cố định');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleCancelGroup = async (groupId: string) => {
        ...
        try {
            await API.post(`/bookings/recurring/${groupId}/cancel-all`, {}, {
                headers: { Authorization: `Bearer ${accessToken}` },
            });
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg p-6 mb-6 shadow-lg">
                    ...
                    <p className="text-purple-100">
                        Quản lý các lịch đặt sân định kỳ
                    </p>
                </div>
