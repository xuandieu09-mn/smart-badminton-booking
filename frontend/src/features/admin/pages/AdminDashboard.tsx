...
export const AdminDashboard: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'overview' | 'bookings' | 'courts' | 'analytics'>('overview');
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Theo dõi hoạt động kinh doanh của sân cầu lông</p>
        </div>
      </div>
      ...
      <div className="flex space-x-1 border-b border-gray-200">
        ...
        <button
          ...
          className={`px-4 py-3 font-medium text-sm ${activeTab === 'bookings'
            ? 'text-indigo-600 border-b-2 border-indigo-600'
            : 'text-gray-600 hover:text-gray-900'
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-3 font-medium text-sm ${activeTab === 'courts'
            ? 'text-indigo-600 border-b-2 border-indigo-600'
            : 'text-gray-600 hover:text-gray-900'
            }`}
        >
      ...
      <div className="mt-6">
        ...
        {activeTab === 'bookings' && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Quản lý đặt sân</h2>
        ...
        {activeTab === 'courts' && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Quản lý sân cầu lông</h2>
            <CourtManagement />
          </div>
        )}
        ...
        {activeTab === 'analytics' && (
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Phân tích doanh thu</h2>
            <PaymentAnalytics />
          </div>
        )}
      </div>
